...
## 6. Базовая настройка Docker для API  

### Проблема  
Ранее я не работала с Docker, но тестовое задание рекомендовало добавить контейнеризацию.  

### Решение  
- Разобралась, как работает `docker-compose`  
- Написала `Dockerfile` для Laravel  
- Создала `docker-compose.yaml` для API  
- Запустила API в контейнере  

---

## 7. Создание профессиональной документации
